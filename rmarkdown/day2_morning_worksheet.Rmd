...
We will be honest: **it is not always immediately clear what the `cols`, `names_to` and `values_to` options are**. If you are really not sure, we recommend taking a small subsample of the data (e.g., using `sample_n()`) and testing things out. There's no shame in this!
